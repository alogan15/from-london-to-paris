...
//                 Reserve your child's spot with a deposit by{" "}
//                 <span className="font-semibold">September 15</span> and receive
//                 <span className="font-bold text-blue-600"> $50 off tuition.</span>
//                 </p>
//             </div>
//           </div>
...
//               className="w-full rounded-xl border border-slate-300 px-5 py-4 focus:border-blue-500 focus:outline-none text-slate-900"
//             />
...
//             <button
//               type="submit"
//               className="w-full rounded-full bg-blue-600 px-8 py-5 text-lg font-semibold text-white transition hover:bg-blue-700 text-slate-900"
//             >
//               Submit Registration
//             </button>
...
import RegistrationForm from "@/components/young-creators/RegistrationForm";
